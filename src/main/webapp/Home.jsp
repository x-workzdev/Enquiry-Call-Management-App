					...
					<div class="panel panel-default">
						<div class="panel-body" align="center" style="margin-left: 20%;">						
						    <ul>
						      ...
						      <li><button type="button" class="btn btn-info" onclick="openkFunc('enquiryManagement','getlatestEnquiries')"><i class="fa fa-eye" aria-hidden="true"></i> View Enquires</button></li>
