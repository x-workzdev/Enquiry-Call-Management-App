                 ...
                 <form  method="POST" action="updateUnsolvedCall.do" style="margin-top: 8%;">
					<table class="col-md-6 table table-bordered table-dark" border="1"
						...
						<tr>
							...
							<td>						
							  <select name="status" class="custom-select custom-select-lg sm-3" value="${callEnquiry.status}">
						...
						<tr>
							...
							<td><input type="date" class="form-control"
								name="intrestedDate"
								placeholder="Enter refrence mobile number" value="${callEnquiry.intrestedDate}"/></td>
						</tr>
