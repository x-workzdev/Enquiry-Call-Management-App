...
<body>
	<div class="backgroundImage">
		<div class="header">
			...
			<div
				style="align-content: flex-basis; width: 6%; margin-bottom: 0.5%;">
			 ...
			 <div class="container" style="align-content: flex-start;">
                  ...
                  <div>
					  <select id="statusFilter">
							<option value="All" label="All Unsolved Calls" />
						...
						<tbody style="color: white;">
							<c:forEach var="callList" items="${callList}">
								<tr>
									...
									<td>
										<%-- <form method="post" action="sendOTP.do"> --%> <input
										id="currentEnquiry" type="hidden" type="number"
										...
										class="sentOTP" style="display: none;"><i
											class="fa fa-check"></i> Sent</span> <!-- </form> -->
									</td>
									<td><form method="post"
